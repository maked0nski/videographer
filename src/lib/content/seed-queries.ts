...
export async function getSiteSettings(locale: Locale): Promise<ResolvedSiteSettings> {
  return {
    ...
    navHomeLabel: resolveLocalized(siteSettings.navHomeLabel, locale) ?? "",
    navWorkLabel: resolveLocalized(siteSettings.navWorkLabel, locale) ?? "",
    navAboutLabel: resolveLocalized(siteSettings.navAboutLabel, locale) ?? "",
    footerRightsText: resolveLocalized(siteSettings.footerRightsText, locale) ?? "",
    watchShowreelLabel: resolveLocalized(siteSettings.watchShowreelLabel, locale) ?? "",
    selectedWorkHeading: resolveLocalized(siteSettings.selectedWorkHeading, locale) ?? "",
    viewAllWorkLabel: resolveLocalized(siteSettings.viewAllWorkLabel, locale) ?? "",
    photographyHeading: resolveLocalized(siteSettings.photographyHeading, locale) ?? "",
    viewPhotographyLabel: resolveLocalized(siteSettings.viewPhotographyLabel, locale) ?? "",
    contactCtaButtonLabel: resolveLocalized(siteSettings.contactCtaButtonLabel, locale) ?? "",
    workPageHeading: resolveLocalized(siteSettings.workPageHeading, locale) ?? "",
    filterAllLabel: resolveLocalized(siteSettings.filterAllLabel, locale) ?? "",
    filterFilmsLabel: resolveLocalized(siteSettings.filterFilmsLabel, locale) ?? "",
    filterPhotographyLabel: resolveLocalized(siteSettings.filterPhotographyLabel, locale) ?? "",
    behindTheScenesHeading: resolveLocalized(siteSettings.behindTheScenesHeading, locale) ?? "",
    previousProjectLabel: resolveLocalized(siteSettings.previousProjectLabel, locale) ?? "",
    nextProjectLabel: resolveLocalized(siteSettings.nextProjectLabel, locale) ?? "",
    yearFieldLabel: resolveLocalized(siteSettings.yearFieldLabel, locale) ?? "",
    locationFieldLabel: resolveLocalized(siteSettings.locationFieldLabel, locale) ?? "",
    roleFieldLabel: resolveLocalized(siteSettings.roleFieldLabel, locale) ?? "",
    producerDirectorFieldLabel: resolveLocalized(siteSettings.producerDirectorFieldLabel, locale) ?? "",
