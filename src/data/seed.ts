...
export const siteSettings: SiteSettings = {
  ...
  navHomeLabel: { en: "Home", uk: "Головна" },
  navWorkLabel: { en: "Work", uk: "Роботи" },
  navAboutLabel: { en: "About & Contact", uk: "Про мене й контакти" },
  footerRightsText: { en: "All rights reserved.", uk: "Усі права захищені." },
  watchShowreelLabel: { en: "Watch Showreel", uk: "Дивитись шоуріл" },
  selectedWorkHeading: { en: "Selected Work", uk: "Вибрані роботи" },
  viewAllWorkLabel: { en: "View all work", uk: "Усі роботи" },
  photographyHeading: { en: "Photography", uk: "Фотографія" },
  viewPhotographyLabel: { en: "View photography", uk: "Переглянути фотографії" },
  contactCtaButtonLabel: { en: "Get in touch", uk: "Зв'язатися" },
  workPageHeading: { en: "Work", uk: "Роботи" },
  filterAllLabel: { en: "All", uk: "Усі" },
  filterFilmsLabel: { en: "Films", uk: "Фільми" },
  filterPhotographyLabel: { en: "Photography", uk: "Фотографія" },
  behindTheScenesHeading: { en: "Behind the Scenes", uk: "Закадрові кадри" },
  previousProjectLabel: { en: "Previous project", uk: "Попередній проєкт" },
  nextProjectLabel: { en: "Next project", uk: "Наступний проєкт" },
  yearFieldLabel: { en: "Year", uk: "Рік" },
  locationFieldLabel: { en: "Location", uk: "Локація" },
  roleFieldLabel: { en: "Role", uk: "Роль" },
  producerDirectorFieldLabel: { en: "Producer / Director", uk: "Продюсер / Режисер" },
